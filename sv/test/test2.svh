`ifndef rhAxi4ReqTrans__svh
`define rhAxi4ReqTrans__svh
/************************************************************************************/
// Author: RyanHunter
...
class RhAxi4ReqTrans extends RhAhb5TransBase;
	...
	`uvm_object_utils_begin(RhAxi4ReqTrans)
	...
	extern function  new(string name="RhAxi4ReqTrans");
endclass
function  RhAxi4ReqTrans::new(string name="RhAxi4ReqTrans");
	super.new(name);
endfunction
...
class RhAxi4Vip extends RhAhb5TransBase;
	rand logic [2:0] burst;
	rand logic [`RHAHB5_AW_MAX-1:0] addr;
	rand logic [6:0] prot;
	rand logic lock;
	...
	`uvm_object_utils_begin(RhAxi4Vip)
		`uvm_field_int(burst,UVM_ALL_ON)
		`uvm_field_int(addr,UVM_ALL_ON)
		`uvm_field_int(prot,UVM_ALL_ON)
		`uvm_field_int(lock,UVM_ALL_ON)
		...
		`uvm_field_int(wdata,UVM_ALL_ON)
	`uvm_object_utils_end
	extern function  new(string name="RhAxi4Vip");
endclass
function  RhAxi4Vip::new(string name="RhAxi4Vip");
	super.new(name);
endfunction
